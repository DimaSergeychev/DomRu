    ...
    public partial class MainFMaster : Form
    {
        ...
        public MainFMaster(Staff master)
        {
            ...
            foreach (DataClasses.Application it in applications)
            {
                ...
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["serv"].Value = it.client.surname + " " + it.client.name;
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["Address"].Value = it.order.address;
